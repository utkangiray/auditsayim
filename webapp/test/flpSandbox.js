		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Audit Sayım",
									"targetURL": "#comauditictasauditsayim-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comauditictasauditsayim-display": {
								"semanticObject": "comauditictasauditsayim",
								"action": "display",
								"description": "Audit Sayım",
								"title": "Audit Sayım",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.audit.ictas.auditsayim",
									"url": sap.ui.require.toUrl("com/audit/ictas/auditsayim")
								}
							}
						}
					}
